...
export default function TipsPage() {
  ...
  const fetchPosts = async () => {
    try {
      if (isSupabaseConfigured()) {
        ...
        setPosts(mockPosts.filter((p) => p.category === '팁 & 트릭'));
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-raycast-white">
      ...
      />
      <Script id="ezoic-init-tips" strategy="afterInteractive">
        {`
          ...
          <div className="mb-6">
            <button
              onClick={() => {
                ...
                router.push('/community/write?category=팁 & 트릭');
              }}
